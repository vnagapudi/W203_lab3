...
2. Apply transformations in X variables and try to figure out if r.squared improves or MSE goes down (this requires a model to be built though)
...
```{R, results='asis'}
model1 = lm(crime_data_clean$crmrte ~ crime_data_clean$prbarr + crime_data_clean$prbconv_fix + crime_data_clean$prbpris + crime_data_clean$avgsen)
