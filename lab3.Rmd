...
```{r}
hist(log(crime_data_clean$crmrte), breaks = 50,
...
plot(crime_data_clean$exp_pris_time, crime_data_clean$crmrte,
     main = 'Both Regular')
abline(lm(crime_data_clean$crmrte ~ crime_data_clean$exp_pris_time))

plot(crime_data_clean$exp_pris_time, crime_data_clean$log_crmrte,
     main = 'Crime Rate Log')
abline(lm(crime_data_clean$log_crmrte ~ crime_data_clean$exp_pris_time))

plot(log(crime_data_clean$exp_pris_time), crime_data_clean$log_crmrte,
     main = 'Both Log')
abline(lm(crime_data_clean$log_crmrte ~ log(crime_data_clean$exp_pris_time)))
```
```
